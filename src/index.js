...
const { generateMsg, generaLocationteMsg } = require('./utils/messages')
...
io.on('connection', (socket) => {
    ...
    socket.on('sendLocation', (location, callback) => {
        ...
        io.to(user.room).emit('locationMessage', generaLocationteMsg(user.username, `https://google.com/maps?q=${location.latitude},${location.longitude}`))
        callback()
    })
